...
const ipcApiRoute = {
  hello: "controller.example.dialog",
};
export default {
  props: {
    docPath: {
  ...
  methods: {
    btn() {
      // let fileName =
      //   this.formInline.trans == "3" ? "openFile" : "openDirectory";
      ipc.invoke(ipcApiRoute.hello, { fileName: 'openDirectory' }).then((r) => {
        // r为返回的数据
        // console.log(r)
       this.form.localFolderPath=r.filePaths
      });
    },
    onSubmit() {
      let url =
